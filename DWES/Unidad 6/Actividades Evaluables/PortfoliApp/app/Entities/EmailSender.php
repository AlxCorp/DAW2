...
class EmailSender {
    ...
    public function sendConfirmationMail($name, $surname, $email, $token) {
        $email = (new Email())
            ...
            ->html('<p>Haz click en el siguiente enlace para validar tu correo, tienes 24 horas!</p><br><a href="http://portfoliapp.com/registro/validar/'.$token.'">VALIDA TU CORREO</a>');
