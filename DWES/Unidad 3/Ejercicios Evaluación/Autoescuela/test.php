...
<body>
    <header>
        <h1>Test de Concucir Número <?php echo TESTID+1 ?></h1>
            ...
            foreach ($preguntas as $pregunta) {
                ...
                if (array_search("img".$pregunta["idPregunta"].".jpg", $images)) {
                    ...
                    foreach ($pregunta["respuestas"] as $respuesta) {
                        echo('<input id="'.$respuesta[0].'" type="radio" value="'.$respuesta[0].'" name="respuesta['.$pregunta["idPregunta"].']"/>');
                        echo('<label for="'.$respuesta[0].'"> '.$respuesta.'</label>');
                        echo('<br>');
                    }
